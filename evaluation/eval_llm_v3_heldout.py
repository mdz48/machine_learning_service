# v3: prompt RICO (clasifica) + reglas anti-alucinacion + anclaje DIFUSO (recupera typos del modelo) en dataset heldout.
import json, re, sys, time, urllib.request
from eval_data_heldout import DATA
...
OUTF="/tmp/llm3_heldout.jsonl"; open(OUTF,"w").close()
call("calentando")
...
open("/tmp/llm3_heldout.done","w").write("ok")
